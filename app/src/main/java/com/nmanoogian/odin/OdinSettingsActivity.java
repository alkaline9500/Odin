 ...
 */
public class OdinSettingsActivity extends PreferenceActivity {
    /**
    ...
    private void setupSimplePreferencesScreen() {
        ...
        securityHeader.setTitle(R.string.pref_security);
//        getPreferenceScreen().addPreference(securityHeader);

        // Bind the summaries of EditText/List/Dialog/Ringtone preferences to
        // their values. When their values change, their summaries are updated
        // to reflect the new value, per the Android Design guidelines.
        bindPreferenceSummaryToValue(findPreference("prefAuthKey"));
    }
